...
*   **Repository:** [Based on this structure](https://github.com/HayatAzeem/s.pothole)
...
Please follow the instructions in the [**`do this setup.md`**](https://github.com/HayatAzeem/s.pothole/blob/main/do%20this%20setup.md) file located in the root of this repository.
